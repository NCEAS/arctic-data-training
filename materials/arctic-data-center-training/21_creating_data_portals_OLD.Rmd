...
Content appropriated from ESS-DIVE's portal documentation found [here](https://docs.ess-dive.lbl.gov/portals/).
...
![data-page](images/data-page.png)
...
![materics-page](images/metrics-page.png)
...
Freeform pages are an optional function provided by Arctic Data Center portals. Here, users can add as much supplementary information as needed using markdown. It is highly recommended that users use this feature to create a descriptive **About page** for their portal.
...
![example-page1](images/example-page1.png)

![example-page2](images/example-page2.png)
...
![create-portal](images/create-portal.png)
...
![create-portal2](images/create-portal2.png)
...
![edit-session](images/edit-session.png)
...
![freeform-pages](images/freeform-pages.png)
...
![view-portal](images/view-portal.png)
...
![viewing1](images/viewing1.png)
![viewing2](images/viewing2.png)
